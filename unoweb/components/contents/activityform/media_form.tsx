...
export default function MediaForm({
  ...
  const createNewMediaActivity = async () => {
    setIsLoading(true);

    const new_activity_response = await ActivitiesService.createMediaActivity(
      class_id,
      activitygroup_id,
      title,
      file,
    ...
    <>
      ...
      <div className="row g-3 my-2">
        <div className="col gap-3 d-flex justify-content-end">
          <button className="btn btn-success" onClick={createNewMediaActivity}>
            Concluir
          </button>
          <button
