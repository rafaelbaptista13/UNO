...
export default function EditExerciseActivity({
  activity_id,
  title,
  description,
  media_type,
  ...
  const editExerciseActivity = async () => {
    setIsLoading(true);

    const edit_activity_response = await ActivitiesService.updateExerciseActivity(
      class_id,
      activity_id,
      input_title,
      input_description,
    ...
    <>
      ...
      <div className="row g-3 my-2">
        <div className="col gap-3 d-flex justify-content-end">
          <button className="btn btn-success" onClick={editExerciseActivity}>
            Concluir
          </button>
